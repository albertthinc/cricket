...
class Captains extends CI_Controller {
    ...
    {
        $players  =   $this->users_model->get_users(4);
        
        $this->smarty->assign("players", $players);
        $this->smarty->assign('MESSAGE', $this->session->flashdata('errors'));
        $this->smarty->assign('INNER_TPL', 'captains/list.htm');
        $this->smarty->assign('pageTitle', 'captains - '.APP_NAME);
    ...
    public function create()
    {
        ...
        $this->smarty->assign('INNER_TPL', 'captains/add.htm');
        $this->smarty->assign('pageTitle', 'Captains - '.APP_NAME);
        $this->smarty->view('layout_master');
    }
    ...
    public function edit()
    {
        ...
        $this->smarty->assign('INNER_TPL', 'captains/edit.htm');
        $this->smarty->assign('pageTitle', 'Captains - '.APP_NAME);
        $this->smarty->view('layout_master');
    }
