 ...
 * (Smarty_Internal_Debug::display_debug) using debug console (pop-window)
 * 
...
class MY_Output extends CI_Output
{
	public function _display($output = '')
	{
		...
		// If Smarty is active - NOTE: $this->output->enable_profiler(TRUE) 
        // active Smarty debug to simplify
